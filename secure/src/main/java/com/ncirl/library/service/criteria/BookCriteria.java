package com.ncirl.library.service.criteria;
...
/**
 * Criteria class for the {@link com.ncirl.library.domain.Book} entity. This class is used
 * in {@link com.ncirl.library.web.rest.BookResource} to receive all the possible filtering options from
...
public class BookCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, isbn, name, publishYear, authorId, distinct);
    }
