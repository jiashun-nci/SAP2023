...
import com.ncirl.library.domain.Book;
import com.ncirl.library.repository.BookRepository;
import com.ncirl.library.service.BookQueryService;
import com.ncirl.library.service.BookService;
import com.ncirl.library.service.criteria.BookCriteria;
...
/**
 * REST controller for managing {@link com.ncirl.library.domain.Book}.
 */
@RestController
@RequestMapping("/api")
public class BookResource {
     ...
     */
    @GetMapping("/books")
    public ResponseEntity<List<Book>> getAllBooks(BookCriteria criteria, @org.springdoc.api.annotations.ParameterObject Pageable pageable) {
